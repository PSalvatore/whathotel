...
@section('content')
    ...
    <h1>Hotels 
        @if(Auth::check() && Auth::user()->username === 'admin')
            <a href="hotels/create" style="vertical-align: middle"><img class="btnAnim" src="{{ URL::to('/') }}/icons/Plus_sign.png"></a>
        @endif
    </h1>
            ...
            @else
                @foreach($hotels as $hotel)
                    <tr>
                        ...
                        <td><a href={{ url('reservations/create/'.$hotel->hotel_id) }}><img class="btnAnim" src="{{ URL::to('/') }}/icons/service_bell.png"></a>
                            {{$hotel->hotel_name}}</td>
